...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		String cardNumber = dining.getCreditCardNumber();
		Account account = accountRepository.findByCreditCard(cardNumber);

		MonetaryAmount ammount = restaurant.calculateBenefitFor(account, dining);
		AccountContribution contribution = account.makeContribution(ammount);
